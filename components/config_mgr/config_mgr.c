...
static void set_defaults(void)
{
    ...
    s_cfg.day_brightness  = 60;
    s_cfg.night_brightness = 30;
    s_cfg.day_start_hour  = 8;
...
static void parse_json(const char *json, size_t len)
{
    ...
    json_read_u8(root, "day_brightness",   &s_cfg.day_brightness);
    json_read_u8(root, "night_brightness", &s_cfg.night_brightness);
    json_read_u8(root, "day_start_hour",   &s_cfg.day_start_hour);
...
char *config_to_json(void)
{
    ...
    cJSON_AddNumberToObject(root, "day_brightness",   s_cfg.day_brightness);
    cJSON_AddNumberToObject(root, "night_brightness", s_cfg.night_brightness);
    cJSON_AddNumberToObject(root, "day_start_hour",   s_cfg.day_start_hour);
